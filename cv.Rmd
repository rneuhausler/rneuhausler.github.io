...
Resolving critical timescales over which hydroclimatic variables influence discharge, as well as the significance of their influence on discharge, in the Sagehen Creek watershed within the Sierra Nevada. Observing the watershed as a noisy, nonlinear system of many interacting variables, I will be using information theory statistics for performing causal inference. This research is being conducted as part of a multi-watershed study led by the Environmental System Dynamics Lab at UC Berkeley. <br>

**Comparing discrepancies between social vulnerability indicies associated with Superfund Sites based on varying methods of spatial overlay and resampling** 09/2017 - present  <br>	        	          Analyzing perceived socially vulnerable groups at risk of superfund site failures based on different methodologies used when combining the social data at the census block level with superfund sites represented as spatial point files. This research is conducted with a fellow graduate student in the NSF Data Science Research program, Jacob Bukoski, as a capstone project for the program. <br>
...
**Salmon Creek Endmember Analysis: Methodological Comparison**	     10/2016 - 03/2017 <br>
...
<center>**Clubs and Competitions**</center>
<br>
